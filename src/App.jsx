...
const App = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-slate-100 font-sans">
            <aside className="bg-[rgb(50,75,106)] text-white w-full lg:w-[400px] p-2 lg:p-4 flex-shrink-0 flex flex-row lg:flex-col items-center justify-center shadow-xl lg:rounded-r-3xl">
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <p className="text-center text-slate-200 text-base lg:max-w-sm px-2">
