    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-slate-100 font-sans">
            ...
            <aside className="bg-gradient-to-b from-slate-800 to-slate-900 text-white w-full lg:w-80 p-8 flex flex-col items-center justify-center shadow-xl rounded-r-3xl">
                {/* Logo/Icon can be placed here */}
                <div className="flex flex-col items-center">
                    <div className="mb-4">
                        {/* Simple arch SVG icon */}
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 36V24C12 15.1634 19.1634 8 28 8C36.8366 8 44 15.1634 44 24V36" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="space-y-10">
                        ...
                        <section className="bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
                            ...
                            <div className="bg-gradient-to-b from-slate-50 to-slate-200 p-6 rounded-xl min-h-[150px] space-y-8 border border-slate-100">
                                {selectedFonts.length > 0 && customText.trim() !== '' ? (
                                    selectedFonts.map((font) => (
                                        <div key={`preview-${font}`} className="relative">
                                            ...
                                            <p className="text-3xl text-slate-800 break-words mt-4" style={{ fontFamily: font }}>{customText}</p>
                                        </div>
                                    ))
                                ) : (
