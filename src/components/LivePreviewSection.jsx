...
const LivePreviewSection = ({
  ...
  return (
    <section className="relative overflow-visible rounded-[2rem] border border-slate-200/70 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] p-5 shadow-[0_24px_60px_-36px_rgba(15,23,42,0.16)] sm:p-6 xl:p-7">
      <div className="relative space-y-4">
        <header className="rounded-[1.5rem] border border-slate-200 bg-white px-5 py-5 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.14)] sm:px-6">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="w-full xl:w-auto xl:min-w-[19rem]">
              <div className="inline-flex w-full rounded-[1rem] border border-slate-200 bg-slate-50 p-1.5 shadow-sm xl:w-auto">
                <button
                  type="button"
                  ...
                  className={`flex-1 rounded-[0.85rem] px-4 py-2.5 text-sm font-semibold transition-all xl:min-w-[9rem] ${
                    !showFontMixingMode
                      ? 'bg-white text-slate-900 shadow-[0_10px_18px_-14px_rgba(15,23,42,0.22)]'
        ...
        {hasStandardSelection ? (
          <div className="space-y-4 rounded-[1.6rem] border border-slate-200 bg-white p-4 shadow-[0_20px_44px_-34px_rgba(15,23,42,0.14)] sm:p-5">
          ...
          !monogramInfo && (
            <div className="min-h-[170px] rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.12)]">
