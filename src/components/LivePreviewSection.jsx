...
const LivePreviewSection = ({
  ...
  return (
    <section className="relative overflow-visible rounded-[2rem] border border-slate-200/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.985),rgba(245,242,235,0.965))] p-5 shadow-[0_32px_78px_-50px_rgba(36,50,70,0.16)] sm:p-6 xl:p-7">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute inset-x-0 top-0 h-24 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),transparent)]" />
        <div className="absolute right-10 top-5 h-36 w-36 rounded-full bg-[radial-gradient(circle,rgba(194,209,227,0.18),transparent_72%)]" />
      </div>

      <div className="relative space-y-4">
        <header className="rounded-[1.55rem] border border-[rgba(197,184,161,0.3)] bg-[linear-gradient(180deg,rgba(255,255,255,0.97),rgba(245,241,233,0.95))] px-5 py-5 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.12)] sm:px-6">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="max-w-[44rem]">
              <div className="inline-flex items-center rounded-full border border-[rgba(197,184,161,0.34)] bg-[rgba(244,239,230,0.9)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-600">
                Preview Studio
              </div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3">
                ...
                <span className="inline-flex items-center rounded-full border border-[rgba(83,103,130,0.16)] bg-white/95 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-600 shadow-sm">
                  {modeTitle}
                </span>
              </div>
            ...
            <div className="w-full xl:w-auto xl:min-w-[19rem]">
              <div className="inline-flex w-full rounded-[1rem] border border-[rgba(197,184,161,0.34)] bg-[linear-gradient(180deg,rgba(250,248,243,0.98),rgba(240,235,226,0.95))] p-1.5 shadow-sm xl:w-auto">
                <button
                  type="button"
                  ...
                  className={`flex-1 rounded-[0.85rem] px-4 py-2.5 text-sm font-semibold transition-all xl:min-w-[9rem] ${
                    !showFontMixingMode
                      ? 'bg-[linear-gradient(180deg,#47617e_0%,#2f4258_100%)] text-white shadow-[0_12px_20px_-16px_rgba(47,66,88,0.55)]'
        ...
        {hasStandardSelection ? (
          <div className="space-y-4 rounded-[1.7rem] border border-[rgba(197,184,161,0.28)] bg-[linear-gradient(180deg,rgba(255,255,255,0.97),rgba(244,240,232,0.95))] p-4 shadow-[0_20px_44px_-36px_rgba(15,23,42,0.12)] sm:p-5">
          ...
          !monogramInfo && (
            <div className="min-h-[170px] rounded-[1.5rem] border border-[rgba(197,184,161,0.28)] bg-[linear-gradient(180deg,rgba(255,255,255,0.97),rgba(245,241,233,0.95))] p-6 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.08)]">
