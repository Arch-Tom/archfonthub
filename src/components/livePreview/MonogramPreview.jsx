...
const MonogramPreview = ({ htmlString }) => {
    ...
    return (
        <div className="overflow-hidden rounded-[1.6rem] border border-[rgba(197,184,161,0.28)] bg-[linear-gradient(180deg,rgba(247,249,252,0.96),rgba(239,244,248,0.9))] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_20px_34px_-28px_rgba(51,65,85,0.14)]">
