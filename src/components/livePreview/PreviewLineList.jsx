...
const PreviewLineList = ({
    ...
    <div className="relative overflow-hidden rounded-[1.7rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.97),rgba(247,250,252,0.92))] px-4 py-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.96)] sm:px-6 sm:py-8">
        <div
            ...
            aria-hidden="true"
        >
            <div className="absolute inset-x-0 top-0 h-28 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.06),transparent_72%)]" />
            <div className="absolute bottom-0 left-1/2 h-40 w-[70%] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(148,163,184,0.08),transparent_72%)] blur-3xl" />
        </div>
                        ...
                        return (
                            <button
                                ...
                                className={`group block w-full rounded-[1.15rem] text-left outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 ${
                                    isSelected
                                        ? 'bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,250,252,0.92))] shadow-[0_20px_34px_-28px_rgba(37,99,235,0.22)] ring-1 ring-blue-100/90'
                                ...
                                <div className="relative px-3 py-4 sm:px-4 sm:py-5">
                                    <div className="relative mx-auto flex w-full max-w-[min(100%,58rem)] items-start gap-3 sm:gap-4">
                                        <div className="flex w-7 flex-shrink-0 justify-center pt-1 sm:w-8">
                                            <span
                                                className={`inline-flex min-w-[1.55rem] items-center justify-center rounded-full border px-1.5 py-0.5 text-[10px] font-semibold shadow-sm transition-all duration-200 ${
                                                    isSelected
                                                        ? 'border-blue-200/90 bg-white text-blue-700 shadow-[0_10px_20px_-16px_rgba(37,99,235,0.35)]'
                                                        : 'border-slate-200/90 bg-white/92 text-slate-400 group-hover:border-slate-300 group-hover:text-slate-500'
                                                }`}
                                                aria-hidden="true"
                                            >
                                                {index + 1}
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div
                                                className={`rounded-[1rem] px-2 py-1.5 transition-all duration-200 sm:px-3 sm:py-2 ${
                                                    isSelected
                                                        ? 'bg-white/65'
