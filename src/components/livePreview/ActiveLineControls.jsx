...
const ActiveLineControls = ({
    ...
    return (
        <div className="space-y-5">
            <div className="flex flex-col gap-4 border-b border-slate-200/75 pb-5 lg:flex-row lg:items-start lg:justify-between">
                <div className="max-w-[38rem]">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-3">
                        ...
                        <span className="inline-flex items-center rounded-full border border-blue-100 bg-blue-50/80 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-blue-700">
                            Active line
                        </span>
                    </div>
                ...
                <div className="flex justify-center lg:justify-end">
                    <div className="rounded-[1rem] border border-slate-200/80 bg-white/90 p-1.5 shadow-[0_12px_24px_-20px_rgba(15,23,42,0.18)]">
                        <AlignmentControl
                            textAlign={textAlign}
            ...
            <div className="space-y-5">
                <div>
                    <div className="mb-2.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">
                        Font
                    </div>
